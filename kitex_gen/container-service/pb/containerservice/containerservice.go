...
var (
	containerServiceServiceInfo                = NewServiceInfo()
	containerServiceServiceInfoForClient       = NewServiceInfoForClient()
	containerServiceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return containerServiceServiceInfo
}

// for client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return containerServiceServiceInfoForStreamClient
}

// for stream client
func serviceInfoForClient() *kitex.ServiceInfo {
	return containerServiceServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*pb.ContainerService)(nil)
...
func helloHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(pb.ContainerService).Hello(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *HelloArgs:
		success, err := handler.(pb.ContainerService).Hello(ctx, s.Req)
		if err != nil {
			return err
		}
